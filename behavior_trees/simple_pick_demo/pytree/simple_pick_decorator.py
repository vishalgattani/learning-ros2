...
def create_tree():
    ...
    open_gripper = Inverter(
        name="open_gripper_inverter",
        child=Action(name="open_gripper")
    )
    close_gripper = Inverter(
        name="close_gripper_inverter",
        child=Action(name="close_gripper")
    )
    move_to_object = Inverter(
        name="move_to_object_inverter",
        child=Action(name="move_to_object")
    )
